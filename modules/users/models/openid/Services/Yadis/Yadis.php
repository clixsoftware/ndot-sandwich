 ...
 */
require_once Kohana::find_file('../modules/users/models/openid/Services/Yadis/','PlainHTTPFetcher',TRUE,'php');

//require_once "Services/Yadis/PlainHTTPFetcher.php";
require_once Kohana::find_file('../modules/users/models/openid/Services/Yadis/','ParanoidHTTPFetcher',TRUE,'php');
//require_once "Services/Yadis/ParanoidHTTPFetcher.php";

/**
 * Need this for parsing HTML (looking for META tags).
 */
require_once Kohana::find_file('../modules/users/models/openid/Services/Yadis/','ParseHTML',TRUE,'php');
 ...
 */
require_once Kohana::find_file('../modules/users/models/openid/Services/Yadis/','XRDS',TRUE,'php');
