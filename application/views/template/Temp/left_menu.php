...
<ul class="ul_ch pro_lefmenu clear fl">
 <?php if($myid != $this->userid){ 
    ...
    <li><a href="<?php echo $this->docroot;?>profile/friends?uid=<?php echo $myid; ?>"  title="Friends" class="p_friends">Friends</a>
    	<?php 
			...
			if(($url_seg == "friends" || $url_seg == "invite_friends" ||  $url_seg == "openrequest"  ||  $url_seg == "openinvites" ) && $myid == $this->userid ){
		?>
        	 <li><a href="<?php echo $this->docroot;?>profile/invite_friends" title="Invite Friends" class="text_normal">Invite Friends</a></li>
             <li><a href="<?php echo $this->docroot;?>profile/openinvites" title="Open Friends" class="text_normal">Open Invites</a></li>
             <li><a href="<?php echo $this->docroot;?>profile/openrequest" title="Open Friend Request" class="text_normal">Open Friend Request</a></li>
        <?php
			}
  		?>
    </li>
 ...
 foreach($this->get_module as $mod){
  ...
  ?> 
     	<li>
        <img src="<?php echo $this->docroot;?>/public/themes/<?php echo $this->get_theme;?>/images/leftmenu/<?php echo $module_name; ?>.jpg" border="0"  /><a href="<?php echo $this->docroot.$module_name;?>" title="<?php echo $module_name ?>"><?php echo trim(ucfirst($module_name)) ?></a>
        </li>
