<html>
<link href="<?php echo $this->docroot ?>public/css/compose.css" rel="stylesheet" type="text/css" /
<script>
...
<div class="mail_con"><!--mail_con start-->
...
<label class="name_lable">E-Mail to :</label><input type="text" name="toid" class="tex_box" id="toidname" value="<?php echo $replydata->name; ?>," /><select name="maillist" onChange="loademailto('toidname',this.value);">
...
<label class="name_lable">Subject  :&nbsp;&nbsp;</label><textarea name="mail_subject"  class="tex_box"  id="subject" ><?php echo $replydata->subject; ?></textarea><br /><br />
<label class="name_lable">Message : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><textarea name="mail_message"  class="mceEditor" cols="85" rows="10" id="message"> <?php echo $replydata->subject; ?></textarea>
