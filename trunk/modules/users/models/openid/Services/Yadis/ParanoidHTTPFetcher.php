 ...
 * Interface import
 */
require_once Kohana::find_file('../modules/users/models/openid/Services/Yadis/','HTTPFetcher',TRUE,'php');
...
class Services_Yadis_ParanoidHTTPFetcher extends Services_Yadis_HTTPFetcher {
    ...
    function get($url, $extra_headers = null)
    {
		...
		$valu[] = explode(": ", $header, 2);
		/*list($name, $value) = $valu;
		...
		//$value[7] = 'close';
		list($name, $value) = $valu;
		//print_r($name); echo "<br />";print_r($value);exit;
