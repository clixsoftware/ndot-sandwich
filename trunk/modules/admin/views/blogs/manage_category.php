...
if(aa)
{
window.location='<?php echo $this->docroot;?>admin_blogs/delete_category/?id='+id;
}
}
...
<?php   echo UI::btn_("Submit", "update", "Update", "", "","update","add_category");?>
		...
		<?php  echo UI::btn_("button", "delete_com", "Delete", "", "javascript:window.location='".$this->docroot."admin_blogs/delete_category/?id=".$row->category_id."' ", "delete_com","");?>
