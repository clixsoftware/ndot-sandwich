...
<form class="search_form" name="frm" method="get" action="<?php echo $this->docroot;?>blog/search" onsubmit="return search_valid();" id="frm">
<tr>
...
<tr><td></td><td class="quiet">Enter the Blogs Title or Description.</td></tr>
<tr>
