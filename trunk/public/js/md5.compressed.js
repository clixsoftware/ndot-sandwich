...
function encrypt(){
var _55,state;
_55=hex_md5(document.loginform.txt_password.value);
document.loginform.enc_password.value=_55;
...
function encryptnew(){
var _57,state;
_57=hex_md5(document.loginformnew.txt_password.value);
document.loginformnew.enc_password.value=_57;
state=hex_md5("loginstate");
document.loginformnew.state.value=state;
document.loginformnew.state.value=state;
return true;
}
function mailpopup(_58,obj){
...
if(_58.clientY-50<10){
top=10;
}else{
top=_58.clientY+10;
}
if(_58.clientX+200>800){
_5b=600;
}else{
_5b=_58.clientX+50;
}
...
var _5d="desires";
if(document.all){
window.external.AddFavorite(li,_5d);
}
}
function createRequestObject(){
var ro;
var _5f=navigator.appName;
if(_5f=="Microsoft Internet Explorer"){
